  ...
  try {
    ...
    if (!generalExist) {
      await Setting.create({
        ...
        value: {
          ...
          seo_title:
            "Shop Điện thoại VIP - Điện thoại, laptop, phụ kiện chính hãng",
          seo_description:
            "Cung cấp các sản phẩm công nghệ cao cấp chính hãng chất lượng với mức giá tốt nhất thị trường.",
        },
    ...
    if (!footerExist) {
      await Setting.create({
        ...
        value: {
          about_us:
            "Shop Điện thoại VIP tự hào là đơn vị cung cấp các thiết bị di động, máy tính bảng và phụ kiện chính hãng, uy tín hàng đầu Việt Nam.",
          columns: [
            {
              title: "Giới thiệu",
              links: [
